...
var GridLayout_component = normalizeComponent(
  ...
  GridLayoutvue_type_template_id_67a1f20c_render,
  GridLayoutvue_type_template_id_67a1f20c_staticRenderFns,
  false,
  null,
  null,
  null
...
var components_Vue = window.Storyblok.vue;
...
keys_default()(VueGridLayout).forEach(function (name) {
  components_Vue.component(name, VueGridLayout[name]);
});
